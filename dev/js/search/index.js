(() => {
  // dev/script/components/BookDescription.js
  ...
  // dev/script/components/LibraryBookExist.js
  ...
  // dev/script/pages/search/AppSearch.js
  ...
  // dev/script/pages/search/InputSearch.js
  ...
  // dev/script/pages/search/BookList.js
  ...
  // dev/script/pages/search/BookItem.js
  ...
  // dev/script/pages/search/index.js
