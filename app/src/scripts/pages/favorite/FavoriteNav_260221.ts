...
export default class FavoriteNav extends HTMLElement {
    ...
    public requestUpdate() {
        const currentData = JSON.stringify(bookModel.favoriteCategoryOrder) + this._activeCategory;
    ...
    private _handleKeydown = (e: KeyboardEvent) => {
        const tabs = Array.from(this.querySelectorAll('a[role="tab"]')) as HTMLElement[];
