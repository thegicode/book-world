...
const watchAndCopy = () => {
    const assetsSrcPath = path_1.default.join(config_1.rootPath, "app", "assets");
    const assetsDistPath = path_1.default.join(config_1.rootPath, config_1.buildPath, "assets");
