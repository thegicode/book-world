...
exports.getKyoboBookInfoByIsbn = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (Object.prototype.hasOwnProperty.call(kyoboJson, isbn)) {
                ...
                const href = yield getAnchorHref(isbn);
                if (!href) {
                    return [];
                }
                const bookData = yield getKyoboInfoData(href);
                kyoboJson[isbn] = bookData;
                fs_1.default.writeFileSync(KEYBO_JSON_PATH, JSON.stringify(kyoboJson, null, 4));
                return bookData;
            }
        }
        catch (error) {
...
exports.getKyoboBookInfoByIsbn = getKyoboBookInfoByIsbn;
