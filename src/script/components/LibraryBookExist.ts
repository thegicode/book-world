export default class LibraryBookExist extends HTMLElement {
    ...
    async onLibraryBookExist(button: HTMLButtonElement | null, isbn13: string, library: Record<string, string>): Promise<void> {
    ...
    renderBookExist(data: {hasBook: string, loanAvailable: string}, libName: string, index: number): void {
    ...
    removeLoading(): void {
        const loadingItems = this.querySelectorAll('.library-item[data-loading=true]') as NodeListOf<HTMLElement>
